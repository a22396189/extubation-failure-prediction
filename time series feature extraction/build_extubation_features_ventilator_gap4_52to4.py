...
ventset_path = rf"{MIMIC_DATA_DIR}\data\mimic-iv-3.1\derived\ventilator_setting.parquet"
extub_path = rf"{EXTUBATION_ROOT}\data\outputs\extubation_outcome.csv"
cohort_path = rf"{EXTUBATION_ROOT}\data\outputs\mv_day_unique_subject_filtered.csv"
