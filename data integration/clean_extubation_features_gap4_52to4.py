...
input_path  = Path(rf"{EXTUBATION_ROOT}\data\outputs\gap4_52to4\extubation_features_merged_gap4_52to4_reordered.csv")
output_path = Path(rf"{EXTUBATION_ROOT}\data\outputs\gap4_52to4\extubation_features_cleaned_gap4_52to4.csv")
